...
class RespeakerArray2(object):
    ...
    def set_led_listen(self, enabled):
        #self.pixel_ring.off()
        if(enabled):
            self.pixel_ring.set_color_palette(0x0000FF, 0x00FF00)
        else:
            self.pixel_ring.set_color_palette(0x0000FF, 0xFF0000)
