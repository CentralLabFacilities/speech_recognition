...
- [ros_silero_vad](ros_silero_vad/) using silero VAD for detecting voice activity on a [https://github.com/ros-drivers/audio_common/blob/master/audio_common_msgs/msg/AudioData.msg](AudioData) topic
